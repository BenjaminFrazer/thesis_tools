...
- Create a virtual environment with a python version < 3.8 with the =mkvirtualenv= command see [[id:62704420-c188-4d11-afc0-0a46d46fd345][managing-python-versions]] for details.
...
5. edit =setup.py= for the correct version number (~0.4.3~) see section ref:secProblemWithNILMTKVersioning
6. comment out imports in =nilmtk_contrib/disaggregate/__init__.py= see section ref:secProblemWithConribDependencies
...
** The Problem With NILMTK Versioning <<secProblemWithNILMTKVersioning>>
...
** The Problem With Contrib Dependencies <<secProblemWithConribDependencies>>
